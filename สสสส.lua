...
local path = "Nitro/" .. Players.LocalPlayer.Name .. ".nitro hub.json"

local savedData = {}
pcall(function()
	if isfile(path) then
		savedData = HttpService:JSONDecode(readfile(path))
	end
end)

local function saveToggle(name, state)
	savedData.Toggles = savedData.Toggles or {}
	savedData.Toggles[name] = state
	pcall(function()
...
if core:FindFirstChild("ImageButtonUI") then
	core.ImageButtonUI:Destroy()
end


if core:FindFirstChild("Nitro") then
	core.Nitro:Destroy()
end


local ImageButtonUI = Instance.new("ScreenGui")
ImageButtonUI.Name = "ImageButtonUI"
ImageButtonUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
ImageButtonUI.Parent = core

local ImageButton = Instance.new("ImageButton")
ImageButton.Name = "ImageButton"
ImageButton.BackgroundColor3 = Color3.fromRGB(30, 20, 20)
ImageButton.BackgroundTransparency = 0.1
ImageButton.BorderSizePixel = 0
ImageButton.Position = UDim2.new(0, 74, 0, 28) 
ImageButton.Size = UDim2.new(0, 50, 0, 50)
ImageButton.Image = "rbxassetid://108909653668044"
ImageButton.ImageTransparency = 0
ImageButton.ImageColor3 = Color3.new(1, 1, 1)
ImageButton.AutoButtonColor = false
ImageButton.Parent = ImageButtonUI
...
ImageButton.MouseButton1Click:Connect(function()
	local gui = core:FindFirstChild("Nitro")
	if gui then
...
function library:loader(props)
	...
	close[3].MouseButton1Down:Connect(function()
		close[2].BorderColor3 = Color3.fromRGB(225, 0, 0)
	...
	login[3].MouseButton1Down:Connect(function()
		login[2].BorderColor3 = Color3.fromRGB(225, 0, 0)
		outline:TweenPosition(UDim2.new(1.5,0,0.5,0),Enum.EasingDirection.Out,Enum.EasingStyle.Quad,0.75,true)
		logedin()
		wait(0.05)
...
local window = library:new({textsize = 13.5,font = Enum.Font.RobotoMono,name = "Nitro Script Premium",color = Color3.fromRGB(225,0,0)})
